    ...
    return (
        <section className="section-padding bg-black" >
            ...
            <div className="max-w-7xl mx-auto mb-24">
                {/* TITLE */}
                <div className="mb-20 flex justify-beetween items-end">
                    {/* Text */}
                    <div>
                        ...
                        <p className="text-zinc-400 max-w-md">
                            Find the ideal car for your business needs, family adventures, or spacial moments.
                        </p>
                    </div>
                    {/* BUTTON */}
